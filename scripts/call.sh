CONTRACT=0xd542490eba60e4b4d28d23c5b392b1607438f3cc

cast send --rpc-url 'http://localhost:8547' --private-key 0xb6b15c8cb491557369f3c7d2c287b053eb229daa9c22138887752191c9520659 \
$CONTRACT "init(uint256,uint256,uint256,uint256,uint256,uint256)" 0 10 0 10 10 10

cast send --rpc-url 'http://localhost:8547' --private-key 0xb6b15c8cb491557369f3c7d2c287b053eb229daa9c22138887752191c9520659 \
$CONTRACT "storeSensorData(uint256,uint256,uint256,uint256,uint256)" 1 1 1 1 1
